...
from corpus.event import Event,EventList,EventSeries,EventSeriesList
...
class OrEventSeriesList(EventSeriesList):
    '''
...
<<<<<<< HEAD
    def __init__(self):
        self.events=[]
        super(OREventList, self).__init__("events",Event)        
