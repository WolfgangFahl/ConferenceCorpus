...
class BestFitDistribution():
    ...
    def __init__(self,data,distributionNames:list=None):
        '''
        constructor
    ...
    def best_fit_distribution(self,bins:int=200, ax=None,density:bool=True):
        ...
        for ii, distribution in enumerate(self.distributionNames):
    
            print(f"{ii+1:>3} / {distributionCount:<3}: {distribution}")
